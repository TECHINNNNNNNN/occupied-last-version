-- =================================================================
-- ADD FOREIGN KEY CONSTRAINT FOR RESERVATIONS TABLE
-- =================================================================
-- This migration adds the foreign key constraint between reservations.room_id 
-- and rooms.id to enable proper joins between the tables. This is needed
-- for the MyBookings component to display room names along with reservations.
-- =================================================================
